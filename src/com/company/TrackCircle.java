...
public class TrackCircle implements Adding {

    private TrackCount countTrack;

    public TrackCircle(int number) {
        setDigit(number);
    }
    ...
    public void draw(Graphics g, int startPosX, int startPosY, int excavatorWidth, int excavatorHeight) {
        ...
        g.drawOval(startPosX + 45, startPosY + 110, excavatorWidth - 80, excavatorHeight - 80);
        g.drawOval(startPosX + 75, startPosY + 110, excavatorWidth - 80, excavatorHeight - 80);
        g.drawOval(startPosX + 105, startPosY + 110, excavatorWidth - 80, excavatorHeight - 80);
        g.drawOval(startPosX + 135, startPosY + 110, excavatorWidth - 80, excavatorHeight - 80);
        if (countTrack == TrackCount.five || countTrack == TrackCount.six) {
            ...
            g.setColor(Color.ORANGE);
            g.drawOval(startPosX + 15, startPosY + 110, excavatorWidth - 80, excavatorHeight - 80);
        }
